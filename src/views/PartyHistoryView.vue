        ...
        <div class="bigstory-info" ref="infoContainer">
          <div v-for="(card, index) in cards" :key="index" class="bigstory-info-card">
            ...
            <div class="bigstory-info-card-content">
              ...
              <div class="bigstory-info-card-content-word">
                {{ card.content }}
              </div>
            </div>
          </div>
      ...
      cards: [
        {
          ...
          imgSrc: `${import.meta.env.VITE_RESOURCE_URL}/image/about/history1.jpg`,
        },
        {
          year: "2015年",
          title: "黨的初創與社會參與",
          ...
          imgSrc: `${import.meta.env.VITE_RESOURCE_URL}/image/about/history2.jpg`,
        },
        {
          year: "2017年",
          title: "緯育黨的環境保護政策",
          ...
          imgSrc: `${import.meta.env.VITE_RESOURCE_URL}/image/about/history3.jpg`,
        },
        {
          year: "2019年",
          title: "緯育黨的教育政策引起矚目",
          ...
          imgSrc: `${import.meta.env.VITE_RESOURCE_URL}/image/about/history4.jpg`,
        },
        {
          year: "2021年",
          title: "選舉的危機與轉機",
          ...
          imgSrc: `${import.meta.env.VITE_RESOURCE_URL}/image/about/history5.jpg`,
        },
        {
          year: "2022年",
          title: "緯育黨的民主精神與政治開放",
          ...
          imgSrc: `${import.meta.env.VITE_RESOURCE_URL}/image/about/history6.jpg`,
        },
