<template>
    ...
    <div class="pro_info_main">
        ...
        <div>
            <img src="../assets/image/product/product_info_example1.png" alt="">
        </div>
        <div>
            <img src="../assets/image/product/product_info_example2.png" alt="">
        </div>
        <div class="product_info_title">規格說明</div>
        <div class="product_info_title">SIDE GUIDE</div>
        <div>
            <img src="../assets/image/product/product_size_example.png" alt="">
        </div>
    </div>
</template>
